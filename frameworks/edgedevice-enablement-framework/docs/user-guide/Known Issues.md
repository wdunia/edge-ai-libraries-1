...
Magic-9 is support on only the 6.14 LTS Kernel and not supported on the latest LTS Kernel 6.17.x at the moment. User can install the Ubuntu Desktop 24.04.3 with the default kernel version of 6.14x.
Please do not upgrade the OS Distro or the Kernel packages for Magic 9 after the above step.
